...
pub struct Env {
    min_left_margin_px: i32,
    min_top_margin_px: i32,
    min_right_margin_px: i32,
    min_bottom_margin_px: i32,
...
impl Env {
    pub fn new(ctx: &Context) -> Self {
        let initial_margin_px: i32 = ctx.margin_px;
        let mut env = Env {
